...
EXPERIMENTS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "ended_at": "2026-08-05T03:19:49+08:00",
        "decision_variant_id": "control",
        "primary_metric": "exposed_action_rate",
    ...
    },
    {
        ...
        "started_at": "2026-07-24T18:09:16+08:00",
        "ended_at": "2026-08-05T03:19:49+08:00",
        "decision_variant_id": "recommended_top10",
    ...
    },
    {
        ...
        "started_at": "2026-07-24T18:09:16+08:00",
        "ended_at": "2026-08-05T03:19:49+08:00",
        "decision_variant_id": "offer_top10",
    ...
    },
    {
        ...
        "started_at": "2026-07-24T18:09:16+08:00",
        "ended_at": "2026-08-05T03:19:49+08:00",
        "decision_variant_id": "quick_share_bundle",
    ...
    },
    {
        ...
        "experiment_name": "首页内置片单卡 CTA 文案实验",
        "status": "active",
        "traffic_allocation": 1.0,
        "started_at": "2026-08-05T03:19:49+08:00",
        "primary_metric": "exposed_builtin_card_open_rate",
        "description": "针对首页渲染后打开或选择片单率只有 34.3%，仅比较内置片单卡底部行动文案；不改变片单、卡片顺序、海报或推荐理由。",
        "variants": [
            {
                "variant_id": "control",
                "variant_name": "开始整理",
                "weight": 1,
                "config": {"card_action_text": "开始整理"},
            },
            {
                "variant_id": "rank_top_n",
                "variant_name": "先排 Top N",
                "weight": 1,
                "config": {"card_action_text": "先排 Top {top_k}"},
            },
        ],
    },
    {
        "experiment_id": "custom_list_scope_hint_v1",
        "experiment_name": "长自定义片单范围提示实验",
        "status": "active",
        "traffic_allocation": 1.0,
        "started_at": "2026-08-05T03:19:49+08:00",
        "primary_metric": "exposed_start_rate",
        "description": "针对较长任务的完成摩擦，仅在自定义片单不少于 20 部时比较是否展示 Top 10 与完整排序的工作量对照；不预选、不代替用户修改范围。",
        "variants": [
            {
                "variant_id": "control",
                "variant_name": "只显示当前工作量",
                "weight": 1,
                "config": {"show_scope_tradeoff_hint": False},
            },
            {
                "variant_id": "top10_tradeoff_hint",
                "variant_name": "显示 Top 10 工作量对照",
                "weight": 1,
                "config": {"show_scope_tradeoff_hint": True},
            },
        ],
    },
    {
        "experiment_id": "douban_collect_scope_default_v1",
        "experiment_name": "豆瓣已看默认 Top N 实验",
        "status": "active",
        "traffic_allocation": 1.0,
        "started_at": "2026-08-05T03:19:49+08:00",
        "primary_metric": "exposed_start_rate",
        "description": "针对重链路从配置到开始仅 29.2%，仅比较豆瓣已看新配置的默认 Top N（用户始终可改为任意 N 或完整排序）。",
        "variants": [
            {
                "variant_id": "top20_default",
                "variant_name": "默认 Top 20",
                "weight": 1,
                "config": {"default_top_k": 20},
            },
            {
                "variant_id": "top10_default",
                "variant_name": "默认 Top 10",
                "weight": 1,
    ...
    {
        "experiment_id": "sorting_progress_framing_v1",
        "experiment_name": "排序中进度文案实验",
        "status": "active",
        "traffic_allocation": 1.0,
        "started_at": "2026-08-05T03:19:49+08:00",
        "primary_metric": "exposed_completion_rate",
        "description": "针对开始后完成率只有 18.1%，仅比较排序中相同剩余取舍数的中性进度文案与结果导向文案；不改变排序规则、剩余次数或 Top 10 救援入口。",
        "variants": [
            {
                "variant_id": "control",
                "variant_name": "中性剩余次数",
                "weight": 1,
                "config": {"progress_hint_style": "neutral"},
            },
            {
                "variant_id": "outcome_framed",
                "variant_name": "结果导向剩余次数",
                "weight": 1,
                "config": {"progress_hint_style": "outcome"},
            },
        ],
    },
    {
        "experiment_id": "result_share_cta_copy_v1",
        "experiment_name": "结果页分享 CTA 文案实验",
        "status": "active",
        "traffic_allocation": 1.0,
        "started_at": "2026-08-05T03:19:49+08:00",
        "primary_metric": "exposed_share_or_poster_rate",
        "description": "针对完成后的分享或海报动作率只有 22.4%，仅比较已固化的一键分享包主按钮文案；不改变海报、复制内容或分享入口位置。",
        "variants": [
            {
                "variant_id": "control",
                "variant_name": "生成 Top 10 海报",
                "weight": 1,
                "config": {"share_bundle_cta": "生成 Top 10 海报"},
            },
            {
                "variant_id": "invite_friend",
                "variant_name": "生成海报，发给同好猜冠军",
                "weight": 1,
                "config": {"share_bundle_cta": "生成海报，发给同好猜冠军"},
            },
        ],
    },
    {
